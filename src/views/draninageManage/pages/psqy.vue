      ...
      <div class="top">
        <div class="top-item">
          ...
          <div class="top-item-sub">
             <suc-input
              v-model="psqyParams.companyName"
              style="width: 200px"
              placeholder= '企业名称'
            >
            </suc-input>
        ...
        <div class="top-item">
          <el-upload
              ...
              action="api/wjServer/paishui/company/import"
              accept=".xls,.xlsx"
...
import { psqyModal, DeleteModal } from "./model";
...
export default class Psgw extends Vue {
  ...
  exportExcel() {
    let url =
      ...
      "/api/wjServer/paishui/company/export?companyName=" +
      this.psqyParams.companyName 
  ...
  async editInfo(params: any) {
    let url = "wjServer/paishui/company";
    let detailParams = {
      uuid: params,
    };
  ...
  // 列表
  async onpage() {
    this.psqyParams.pageNumber = this.pageParams.current;
    this.psqyParams.pageSize = this.pageParams.pageSize;
    let url = "wjServer/paishui/company/page";
    let data = await publicApi.getWithParam(url, this.psqyParams);
