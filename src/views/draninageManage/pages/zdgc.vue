      ...
      <div class="top">
        ...
        <div class="top-item">
          <el-upload
              ...
              action="api/wjServer/paishui/keyProject/import"
              accept=".xls,.xlsx"
...
import { zdgcModal, DeleteModal } from "./model";
...
export default class Psgw extends Vue {
  ...
  exportExcel() {
    let url =
      "/api/wjServer/paishui/keyProject/export?mc=" +
      this.zdgcParams.mc 
  ...
  async editInfo(params: any) {
    let url = "wjServer/paishui/keyProject/detail";
    let detailParams = {
      id: params,
    };
  ...
  // 列表
  async onpage() {
    this.zdgcParams.pageNumber = this.pageParams.current;
    this.zdgcParams.pageSize = this.pageParams.pageSize;
    let url = "wjServer/paishui/keyProject/infoList";
    let data = await publicApi.getWithParam(url, this.zdgcParams);
