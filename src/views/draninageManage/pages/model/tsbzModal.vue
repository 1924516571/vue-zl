  ...
  <el-dialog :title="title" :visible.sync="model" close-on-click-modal:false :before-close="onCancel" v-if="model">
    <el-form :model="formParams" :rules="rules" ref="tsbzForm" label-width="auto" size="small">
      ...
      <el-form-item label="建设时间">
        <el-input v-model="formParams.buildyear"></el-input>
      </el-form-item>
      <el-form-item label="建设单位">
        <el-input v-model="formParams.buildcompany"></el-input>
      </el-form-item>
      <el-form-item label="管护单位">
        <el-input v-model="formParams.protectcompany"></el-input>
      </el-form-item>
      <el-form-item label="有无管理用房">
        <el-input v-model="formParams.home"></el-input>
      </el-form-item>
      <el-form-item label="是否移交">
        <el-input v-model="formParams.turn"></el-input>
      </el-form-item>
      <el-form-item label="占地面积(m2)">
        <el-input v-model="formParams.area"></el-input>
      </el-form-item>
      <el-form-item label="管理用房面积(m2)">
        <el-input v-model="formParams.homearea"></el-input>
      </el-form-item>
      <el-form-item label="日均提升量（万吨）">
        <el-input v-model="formParams.dayup"></el-input>
      </el-form-item>
