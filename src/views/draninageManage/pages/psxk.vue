      ...
      <div class="top">
        <div class="top-item">
          ...
          <div class="top-item-sub">
             <suc-input
              v-model="psxkParams.licensetype"
              style="width: 200px"
              placeholder= '许可证类型'
            >
            </suc-input>
        ...
        <div class="top-item">
          <el-upload
              ...
              action="api/wjServer/paishui/licence/import"
              accept=".xls,.xlsx"
...
import { psxkModal, DeleteModal } from "./model";
...
export default class Psgw extends Vue {
  ...
  exportExcel() {
    let url =
      ...
      "/api/wjServer/paishui/licence/export?username=" +
      this.psxkParams.username +
      "&licensekey=" +
      this.psxkParams.licensekey
      "&licensetype=" +
      this.psxkParams.licensetype
  ...
  onedit(row: any) {
    ...
    this.btnFlag = "edit";
    this.modalTitle = "详情";
    this.editInfo(row.licensekey);
  }
  // 详情
  async editInfo(params: any) {
    let url = "wjServer/paishui/licence";
    let detailParams = {
      licensekey: params,
    };
  ...
  // 列表
  async onpage() {
    this.psxkParams.pageNumber = this.pageParams.current;
    this.psxkParams.pageSize = this.pageParams.pageSize;
    let url = "wjServer/paishui/licence/page";
    let data = await publicApi.getWithParam(url, this.psxkParams);
