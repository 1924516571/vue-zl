<template>
  ...
  <div class="module-view">
    ...
    <szxc-create-task :model="model" :taskOptions="taskOptions" @toggle-model="toggle" @on-submit="setTask"></szxc-create-task>
  </div>
</template>
<script lang="ts">
...
import { Detail, XcDetail, CreateTask,SzxcCreateTask } from "@/components";
