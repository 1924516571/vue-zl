...
<template>
  <div class="mainContain">
    <!-- 中间 -->
    <async-head></async-head>
    <!-- 左页面 -->
    <async-left></async-left>
    <!--下页面 -->
    <async-bottom></async-bottom>
    <!-- 右面 -->
    <async-right></async-right>
  </div>
</template>
...
import { AsyncLeft, AsyncBottom, AsyncRight, AsyncHead } from "./xtczAsync";
import { SucCheckboxGroup, SucCheckbox } from "@suc/ui";
...
.mainContain {
  ...
  .mainContain_map {
    ...
    .tkOut {
      // width: 206px;
      // height: 9px;
      // background: url("../../~@/assets/dp/Xtcz/背景.png") no-repeat;
