<template>
  ...
  <div class="main">
    ...
    <vue-seamless-scroll :data="gasData" class="alarm scrollDp">
      <div class="alarm-item" v-for="(item, index) in gasData" :key="item.id" @click="onRow(item)">
...
<script lang="ts">
import { Vue, Component, Watch, Provide, Inject, Emit } from "vue-property-decorator";
