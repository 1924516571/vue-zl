...
const color = ["RGBA(250, 207, 45, 1)", "RGBA(247, 152, 28, 1)", "#42a5f5", "#5FF5FE"];
export default {
  name: "ThreeDPie",
  props: {
    optionsData: {
        ...
        tooltip: {
          formatter: (params) => {
            if (params.seriesName !== "mouseoutSeries" && params.seriesName !== "pie2d") {
              ...
              return (
                `${params.seriesName}<br/>` + `<span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:${params.color};"></span>` + `${bfb}%`
              );
            }
          },
        },
