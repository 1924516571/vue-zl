<template>
  <div class="main">
    <div id="rightPie" ref="chart" style="width:150px; height:150px;"></div>
    <div class="tx">
...
export default class RightPie extends Vue {
  //  @Props()
  ...
  chartthreenD1() {
    ...
    let pieData = [408, 398, 86];
    let sum = Math.max(...pieData);
    let min = Math.min(...pieData);
    let pieSeries: any = [];
    pieData.forEach((v, i) => {
      pieSeries.push({
        type: "pie",
    ...
    var myChart: any = echarts.init(document.getElementById("rightPie") as any);
    let option: any = {
