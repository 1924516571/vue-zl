  ...
  >
    ...
    >
      <div>
        ...
        <el-form-item label="圩名">
          <el-input v-model="formParams.plodername"></el-input>
        </el-form-item>

        <el-form-item label="包大圩单位">
      ...
      <div>
        ...
        <el-form-item label="集水面积(亩)">
          <el-input v-model="formParams.waterarea"></el-input>
        </el-form-item>
