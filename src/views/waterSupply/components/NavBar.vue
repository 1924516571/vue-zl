<template>
  <div class="side-menu-container">
    ...
    <suc-submenu name="1">
        ...
        <suc-menu-item name="ysdw" to="/main/waterSupply/ysdw">
          <span class="txt">用水单位</span>
        </suc-menu-item>
        <suc-menu-item name="gsgw" to="/main/waterSupply/gsgw">
          <span class="txt">供水管网</span>
        </suc-menu-item>
      </suc-submenu>
      <suc-submenu name="2">
        <template slot="title">
          <span style="vertical-align:sub;"><img style="heigth:20px;width:20px" src="@/assets/projectOperation/统计.png" alt="" /> </span>
          <span class="txt">实时监管</span>
        </template>
        <suc-menu-item name="gsfx" to="/main/waterSupply/gsfx">
          <span class="txt">供水分析</span>
        </suc-menu-item>
        <suc-menu-item name="gsjc" to="/main/waterSupply/gsjc">
          <span class="txt">供水监测</span>
        </suc-menu-item>
      </suc-submenu>
      <suc-submenu name="3">
        <template slot="title">
          <span style="vertical-align:sub;"><img style="heigth:20px;width:20px" src="@/assets/water/水质.png" alt="" /> </span>
          <span class="txt">设施养护</span>
        </template>
        <suc-menu-item name="jhqd" to="/main/waterSupply/jhqd">
          <span class="txt">计划清单</span>
        </suc-menu-item>
        <suc-menu-item name="yhjl" to="/main/waterSupply/yhjl">
          <span class="txt">养护记录</span>
        </suc-menu-item>
        <suc-menu-item name="rwgl" to="/main/waterSupply/rwgl">
