<template>
  ...
  <div class="info">
      ...
      <div class="top">
        <div class="top-item">
          <div class="top-item-sub">
            <search-component placeholderTxt="避灾场所名称" @input="onSearch"> </search-component>
          </div>
        </div>
        <div class="top-item">
    ...
    <!-- 新增数据弹框 -->
    <bzcs-modal :title="modalTitle" :model="model" v-loading="loading" :formParams="formParams" @on-submit="oncreate" @toggle="toggle"></bzcs-modal>
    <!-- 删除弹框 -->
...
export default class Enterprise extends Vue {
  ...
  async onpage() {
    ...
    let url = "wjServer/dataCenter/baseinfo/bzcs/page";
