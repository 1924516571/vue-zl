<template>
  ...
  <div class="info">
    <div class="info-view bg-shadow">
      <div class="top">
        <div class="top-item">
          ...
          <div class="top-item-sub">
            <search-component placeholderTxt="格栅名称" @input="onSearch"> </search-component>
          </div>
        </div>
        <div class="top-item">
    ...
    <!-- 新增数据弹框 -->
    <grille-modal :title="modalTitle" :model="model" :loading="loading" :formParams="formParams" @on-submit="oncreate" @toggle="toggle" :chuan="chuan"></grille-modal>
    <!-- 删除弹框 -->
...
export default class Enterprise extends Vue {
  ...
  async save() {
    ...
    let url = "wjServer/dataCenter/basic/grille";
  ...
  async editInfo(id: any) {
    ...
    this.formParams = {
      grillecode: data.data.grillecode,
      name: data.data.name,
  ...
  onSearch(val: string) {
    this.loading = true;
    this.pageParams.current = 1;
    this.stationParams.grilleName = val;
    this.onpage();
  }
