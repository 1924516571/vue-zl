<template>
  <div class="info">
    <div class="info-view bg-shadow">
      <div class="top">
        <div class="top-item">
          ...
          <div class="top-item-sub">
            <search-component placeholderTxt="塘坝名称" @input="onSearch"> </search-component>
          </div>
        </div>
        <div class="top-item">
    ...
    <!-- 新增数据弹框 -->
    <tb-modal :title="modalTitle" :model="model" :loading="loading" :formParams="formParams" @on-submit="oncreate" @toggle="toggle" :chuan="chuan"></tb-modal>
    <!-- 删除弹框 -->
...
import { DeleteModal, TbModal} from "../model";
...
export default class Enterprise extends Vue {
 ...
 // 点击地图获取经纬度
  ...
  async save() {
    ...
    let url = "wjServer/dataCenter/tangba";
  ...
  async onpage() {
    ...
    let url = "wjServer/dataCenter/tangba/page";
