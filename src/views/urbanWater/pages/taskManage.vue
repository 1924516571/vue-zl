<template>
  ...
  <div class="module-view">
    <div class="top bg-shadow">
      ...
      <!-- v-show="addButton.roleName == 'manager' || addButton.roleName == '超级管理员'" -->
      <div class="top-item flex-class">
        <div class="top-item-sub">
    ...
    <!-- <create-task :model="model" :taskOptions="taskOptions" @toggle-model="toggle" @on-submit="setTask"></create-task> -->
    <task-manage-create-task :model="model" :taskOptions="taskOptions" @toggle-model="toggle" @on-submit="setTask"></task-manage-create-task>
  </div>
</template>
<script lang="ts">
...
import { Detail, XcDetail, CreateTask, TaskManageCreateTask } from "@/components";
