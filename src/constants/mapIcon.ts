// 燃气图标
const swzIcon: any = {
  warn1:require("@/assets/dp/AsyncMonitore/red.png"), //一级报警
  warn2:require("@/assets/dp/AsyncMonitore/orange.png"), //二级报警
  warn3:require("@/assets/dp/AsyncMonitore/yellow.png"),  //三级报警
};
