...
const { url, backUrl } = require("./public/config.js");
...
module.exports = {
  ...
  transpileDependencies: [/authox-vue/gi, "vue-echarts", "resize-detector", "@suc/module", /monch/gi, /iview.src.(?!utils.date\.js\b).+js$/],
  chainWebpack: (config) => {
